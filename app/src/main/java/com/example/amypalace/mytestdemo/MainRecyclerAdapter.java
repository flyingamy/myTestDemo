...
/**
 * Created by AmyPalace on 2/5/2018.
 */
...
//        holder.mTitle.setText((CharSequence) mList.get(position).get("product_title"));
        String product_title = mList.get(position).get("product_title") == null ?
                "" : mList.get(position).get("product_title").toString();
        Log.i("product_title", "============" + product_title);
//        holder.mTitle.setText((CharSequence) product_title);
        holder.mTitle.setText(product_title);
        String url = mList.get(position).get("image_url") == null ?
            "www": mList.get(position).get("image_url").toString();
        Log.i("url", "============" + url);
...
//        holder.mName.setText(mList.get(position).getAVUser("owner") == null ? "" : mList.get(position).getAVUser("owner").getUsername());
        Picasso.with(mContext).load(url).transform(new RoundedTransformation(9, 0)).into(holder.mPicture);
